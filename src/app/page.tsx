...
const products = [
  { name: 'KVM VPS 2GB', cpu: '1 vCPU', ram: '2GB RAM', storage: '25GB NVMe', price: 15000, icon: Server, color: 'from-blue-600 to-cyan-600' },
  { name: 'KVM VPS 4GB', cpu: '2 vCPU', ram: '4GB RAM', storage: '50GB NVMe', price: 27000, icon: Server, popular: true, color: 'from-indigo-600 to-purple-600' },
  { name: 'KVM VPS 8GB', cpu: '4 vCPU', ram: '8GB RAM', storage: '100GB NVMe', price: 51000, icon: Cpu, color: 'from-purple-600 to-pink-600' },
  { name: 'KVM VPS 10GB', cpu: '6 vCPU', ram: '10GB RAM', storage: '150GB NVMe', price: 72000, icon: Cpu, color: 'from-pink-600 to-red-600' },
  { name: 'Supabase Managed', cpu: 'Auto-scaling', ram: 'Managed', storage: 'Unlimited DB', price: 45000, icon: Database, color: 'from-green-600 to-emerald-600' },
  { name: 'n8n Automation', cpu: 'Dedicated', ram: '2GB RAM', storage: '20GB SSD', price: 36000, icon: Workflow, color: 'from-orange-600 to-amber-600' },
  { name: 'Linux Dev Server', cpu: '2 vCPU', ram: '4GB RAM', storage: '40GB SSD', price: 30000, icon: Terminal, color: 'from-teal-600 to-cyan-600' },
  { name: 'PowerShell Remote', cpu: '2 vCPU', ram: '4GB RAM', storage: '40GB SSD', price: 33000, icon: Monitor, color: 'from-violet-600 to-indigo-600' },
]
        ...
        <div className="max-w-6xl mx-auto text-center relative">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
            ...
            <p className="text-lg md:text-xl text-zinc-400 max-w-3xl mx-auto mb-10 leading-relaxed">
              ...
              Developer-first cloud infrastructure from Silicon Valley. Starting at <span className="text-white font-semibold">$15,000/year</span>.
            </p>

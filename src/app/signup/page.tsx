    ...
    <div className="min-h-screen flex items-center justify-center px-6 hero-gradient">
      <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <p className="text-zinc-500">Start deploying in seconds</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="glass rounded-2xl p-8 space-y-5">
          <div>
            ...
            <div className="relative">
              ...
              <input type="text" value={form.name} onChange={e => setForm({ ...form, name: e.target.value })} required className="w-full bg-zinc-900 border border-zinc-700 rounded-xl pl-10 pr-4 py-3 text-white focus:border-indigo-500 outline-none" placeholder="John Doe" />
            </div>
          </div>
          <div>
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input type="password" value={form.password} onChange={e => setForm({ ...form, password: e.target.value })} required minLength={8} className="w-full bg-zinc-900 border border-zinc-700 rounded-xl pl-10 pr-4 py-3 text-white focus:border-indigo-500 outline-none" placeholder="Min 8 characters" />
            </div>
          </div>
          ...
          <p className="text-center text-sm text-zinc-500">Already have an account? <Link href="/login" className="text-indigo-400 hover:text-indigo-300 font-semibold">Log in</Link></p>
        </form>
      </motion.div>
    </div>
  )
